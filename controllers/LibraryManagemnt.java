...
public class LibraryManagemnt {
    ...
    private int saveFormat = 1; // 1: List/Map, 2: Text, 3: Excel
    ...
    public void manageLibrary() {
        ...
        System.out.println("4. Convert save format");
        ...
        dt.saveDataToText(books, members, borrowingRecords);
    }
    ...
    private void initSampleMembers() {
        ...
        members.put("M010", new Member("M01", "Jack Taylor", "jack@example.com", "0123456789"));
    }

    private void converSaveFormat() {
        System.out.println("Converting save format...");
        System.out.println("Choose the format to convert to:");
        ...
        if (saveFormat == 2) {
            ...
            System.out.println("Only input numbers 1, 2, or 3.");
        }
    }
